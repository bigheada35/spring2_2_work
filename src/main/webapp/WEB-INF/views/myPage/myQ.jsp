						...
						<div class="col-md-9 contact-info"
							...
							<table id="report" class="table">
								...
								<tbody>
									...
									<c:forEach var="list" items="${view_list}"
										varStatus="status">
										<tr>
											
											<td><a href="${pageContext.request.contextPath}/qcontent_view?board_id=${list.board_id}" style="text-decoration:none; color:black"><c:out value="${list.board_title}"/></a></td>
