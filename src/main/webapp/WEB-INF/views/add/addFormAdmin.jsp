...
<!-- property area -->
        <div class="property-area" style="float: none; margin:100 auto;"></div>
        <div class="container">
            <div class="input-form-backgroud row">
                <div class="input-form col-md-6 mx-auto" style="float: none; margin:0 auto;">
                    ...
                    <form name="frmMember" id="frmMember" action="${addAdminUrl}" method="POST">
                        ...
                        <br>
                        <div class="mb-4"></div>
                        <button class="btn btn-warning btn-lg btn-block" type="submit">가입 완료</button>
                    </form>
                </div>
            </div>
        </div>
