...
<link rel="shortcut icon" href="favicon.ico" type="/resources/jjk/images/x-icon">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 ">
                            <div class="single-footer">
                                ...
                                <img src="/resources/jjk/assets\img\공부어때.jpg" alt="" class=" " data-wow-delay="1s">
                        ...
                        <div class="col-md-3 col-sm-6 ">
                            <div class="single-footer news-letter">
                                ...
                                <div class="social pull-right"> 
                                    <ul>
                                        <li><a class="  " href="https://twitter.com/Kbat"><i class="fa fa-twitter"></i></a></li>
                                        <li><a class= href="https://www.facebook.com/Kbat" data-wow-delay="0.2s"><i class="fa fa-facebook"></i></a></li>
                                        <li><a class="  " href="https://plus.google.com/Kbat" data-wow-delay="0.3s"><i class="fa fa-google-plus"></i></a></li>
                                        <li><a class="  " href="https://instagram.com/Kbat" data-wow-delay="0.4s"><i class="fa fa-instagram"></i></a></li>
                                        <li><a class="  " href="https://instagram.com/Kbat" data-wow-delay="0.6s"><i class="fa fa-dribbble"></i></a></li>
                                    </ul> 
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="bottom-menu pull-right"> 
                            <ul> 
                                <li><a class="  " href="#" data-wow-delay="0.2s">카테고리</a></li>
                                <li><a class="  " href="#" data-wow-delay="0.3s">공지사항</a></li>
                                <li><a class="  " href="#" data-wow-delay="0.4s">로그인</a></li>
                                <li><a class="  " href="#" data-wow-delay="0.6s">Content</a></li>
                            </ul> 
                        </div>
                    </div>
                </div>
